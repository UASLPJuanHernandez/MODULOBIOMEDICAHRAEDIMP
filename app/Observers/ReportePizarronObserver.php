...
class ReportePizarronObserver
{
    ...
    public function updated(ReportePizarron $reporte): void
    {
        ...
        BitacoraReporte::create([
            ...
            'area_departamento'    => $area ?? $reporte->reportante_servicio,
            ...
            'nombre_dispositivo'   => $reporte->nombre_dispositivo ?? $reporte->equipo,
            'marca'                => $reporte->marca,
            'modelo'               => $reporte->modelo,
            'numero_serie'         => $reporte->numero_serie,
            'numero_control'       => $reporte->numero_control,
            'tipo_servicio'        => $reporte->tipo_servicio,
            'tipo_baja'            => $reporte->tipo_baja,
            'atiende_nombre'       => null,
            'recibe_nombre'        => null,
        ]);
    }
