...
<div class="flex flex-col" style="height: calc(100vh - 130px);">
    ...
    <div class="firmar-header flex items-center justify-between mb-4 flex-wrap gap-3">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">Firmar bitácora</h2>
                <p class="text-xs text-gray-400 dark:text-gray-500">
                    {{ $this->record->nombre_personal }} — {{ $this->record->area_departamento }}
                    &mdash; {{ \Carbon\Carbon::parse($this->record->fecha_reporte)->format('d/m/Y') }}
                </p>
            </div>
        </div>
