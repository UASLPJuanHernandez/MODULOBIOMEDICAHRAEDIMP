            ...
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                ...
                <td class="py-3.5 text-right" style="padding-right:1.5rem">
                    <div class="flex items-center justify-end gap-1.5">
                        ...
                        {{-- Botón PDF --}}
                        @if($reg->formato && $reg->estado !== 'pendiente')
                        <a href="{{ route('admin.registro.pdf', $reg) }}" target="_blank"
                           class="inline-flex items-center gap-1 text-xs font-semibold px-3 py-1.5 rounded-lg transition
                                  bg-primary-100 hover:bg-primary-200 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
