...
>
    ...
    {{-- Restaurar componente de notificaciones ahora que broadcasting se habilitará --}}
    ...
    {{-- Carga normal: se elimina mock forzado de Echo --}}

        @filamentScripts(withCore: true)

    {{-- Incluir script compilado (Vite) que inicializa Echo con Reverb --}}
    ...
    {{-- Eliminado safeguard de mock ya que ahora se usa Echo real --}}
